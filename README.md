...
2. Navigate to you home directory where you wish to install the API service and type `git clone https://github.com/xploretv2go/zeroconf.api.service.git` command
3. Run `sh install.sh` script as a root to install the API on to your device
